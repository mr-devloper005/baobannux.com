export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'baobannux',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Baobannux',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'baobannux.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://baobannux.com',
