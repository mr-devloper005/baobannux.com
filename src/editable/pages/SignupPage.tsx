    ...
    <EditableSiteShell>
      <main className="bg-[var(--slot4-panel-bg)] text-[var(--slot4-page-text)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[0.9fr_1fr] lg:px-8">
          ...
          <div>
            <p className="editable-mono text-[0.72rem] uppercase tracking-[0.12em] text-[var(--slot4-accent)]">{pagesContent.auth.signup.badge}</p>
            <h2 className="editable-display mt-5 max-w-xl text-[2.6rem] font-bold leading-[1.05] tracking-[-0.03em] sm:text-[3.4rem]">{pagesContent.auth.signup.title}</h2>
